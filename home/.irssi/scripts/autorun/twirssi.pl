...
Irssi::theme_register(
    [
        'twirssi_tweet',       '[$0%G@$1%n$2] $3',
        'twirssi_search',      '[$0%m$1%n:%G@$2%n$3] $4',
        'twirssi_search_once', '[$0%m$1%n:%G@$2%n$3] $4',
        'twirssi_reply',       '[$0\--> %G@$1%n$2] $3',
        'twirssi_dm',          '[$0%m@$1%n (%WDM%n)] $2',
...
Irssi::settings_add_str( "twirssi", "twirssi_nick_color",       "%G" );
Irssi::settings_add_str( "twirssi", "twirssi_topic_color",      "%m" );
